...
export const AUTH0_SECOND_TEST_ID = "auth0|6205adcf48929b007055fc4d";
export const AUTH0_THIRD_TEST_ID = "auth0|6205adcf48929b007055fc4a";
export const TEST_NAME_1 = "First Name";
export const TEST_NAME_2 = "Second Name";
export const TEST_NAME_3 = "Thid Name";
...
export const TEAM_TEST_ID_3 = "a124acefaabaaa425aabbaaa";
export const TEAM_TEST_ID_4 = "a124acefaabaaa425aabbaab";
export const TEAM_TEST_ID_5 = "a124acefaabaaa425aabbaad";
...
export const TEAM_TEST_BIO_ONE =
  "Cillum duis pariatur tempor nulla commodo pariatur est fugiat voluptate minim minim cupidatat proident aute. Tempor occaecat qui in dolore eu. Consectetur enim culpa duis consequat consectetur minim reprehenderit excepteur. Aliqua sit commodo magna sit duis incididunt laborum irure officia irure ipsum et Lorem. Reprehenderit ipsum adipisicing reprehenderit magna ipsum irure ipsum.";
export const TEAM_TEST_DISIRED_ROLES = ["Frontend", "Backend"];
